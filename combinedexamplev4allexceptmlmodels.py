...
from tkinter import Button, Label, Entry, StringVar, END, Listbox, Scrollbar, Toplevel, Checkbutton, IntVar, Radiobutton, filedialog  # Added filedialog
...
def preload_whisper_model():
    ...
    try:
        whisper.load_model("tiny")  # Change "base" to the desired model size: "tiny", "small", "medium", or "large"
